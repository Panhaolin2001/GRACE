; ModuleID = '/home/xxx/.local/share/compiler_gym/llvm-v0/benchmark/blas-v0/contents/blas-v0/81.bc'
...
L.LB1_309:                                        ; preds = %L.entry
  ...
  store float %82, float* %.elt, align 4, !dbg !31, !tbaa !12
  store float %83, float* %.elt25, align 4, !dbg !31, !tbaa !12
  br label %L.LB1_310
