; ModuleID = '/home/xxx/.local/share/compiler_gym/llvm-v0/benchmark/mibench-v1/contents/mibench-v1/tiffdither-1.bc'
source_filename = "-"
...
define void @astex_codelet__8(i8* %0, i32 %1, i8* %2, i32 %3, i32* %4, i32* %5) #0 {
  %7 = alloca i8*, align 8
...
25:                                               ; preds = %21, %2
  ...
  %43 = call i32 (i8*, ...) @__astex_write_message(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.3, i64 0, i64 0), i8* %42)
...
77:                                               ; preds = %74
  ...
  call void @astex_codelet__8(i8* %80, i32 %81, i8* %82, i32 %83, i32* %84, i32* %85)
  br label %74
