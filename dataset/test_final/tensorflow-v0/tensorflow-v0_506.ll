; ModuleID = '/home/xxx/.local/share/compiler_gym/llvm-v0/benchmark/tensorflow-v0/contents/tensorflow-v0/506.bc'
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_libsvm_ops.cc, i8* null }]
...
define internal void @"_ZN10tensorflow3$_08__invokeEPNS_15shape_inference16InferenceContextE"(%"class.tensorflow::Status"* noalias nocapture sret %0, %"class.tensorflow::shape_inference::InferenceContext"* %1) #3 align 2 {
  %3 = getelementptr inbounds %"class.tensorflow::shape_inference::InferenceContext", %"class.tensorflow::shape_inference::InferenceContext"* %1, i64 0, i32 1, i32 0, i32 0
  %4 = bitcast %"class.tensorflow::shape_inference::ShapeHandle"** %3 to i64**
  %5 = load i64*, i64** %4, align 8, !tbaa !2, !noalias !8
  %6 = load i64, i64* %5, align 8, !noalias !8
  %7 = getelementptr inbounds %"class.tensorflow::shape_inference::InferenceContext", %"class.tensorflow::shape_inference::InferenceContext"* %1, i64 0, i32 4, i32 0, i32 0
  %8 = bitcast %"class.tensorflow::shape_inference::ShapeHandle"** %7 to i64**
  %9 = load i64*, i64** %8, align 8, !tbaa !2, !noalias !8
  store i64 %6, i64* %9, align 8, !noalias !8
  %10 = tail call %"class.tensorflow::shape_inference::Shape"* @_ZN10tensorflow15shape_inference16InferenceContext6MatrixENS0_19DimensionOrConstantES2_(%"class.tensorflow::shape_inference::InferenceContext"* %1, %"class.tensorflow::shape_inference::Dimension"* null, i64 -1, %"class.tensorflow::shape_inference::Dimension"* null, i64 -1) #6, !noalias !8
  %11 = load %"class.tensorflow::shape_inference::ShapeHandle"*, %"class.tensorflow::shape_inference::ShapeHandle"** %7, align 8, !tbaa !2, !noalias !8
  %12 = getelementptr inbounds %"class.tensorflow::shape_inference::ShapeHandle", %"class.tensorflow::shape_inference::ShapeHandle"* %11, i64 1, i32 0
  store %"class.tensorflow::shape_inference::Shape"* %10, %"class.tensorflow::shape_inference::Shape"** %12, align 8, !noalias !8
  %13 = tail call %"class.tensorflow::shape_inference::Shape"* @_ZN10tensorflow15shape_inference16InferenceContext6VectorENS0_19DimensionOrConstantE(%"class.tensorflow::shape_inference::InferenceContext"* %1, %"class.tensorflow::shape_inference::Dimension"* null, i64 -1) #6, !noalias !8
  %14 = load %"class.tensorflow::shape_inference::ShapeHandle"*, %"class.tensorflow::shape_inference::ShapeHandle"** %7, align 8, !tbaa !2, !noalias !8
  %15 = getelementptr inbounds %"class.tensorflow::shape_inference::ShapeHandle", %"class.tensorflow::shape_inference::ShapeHandle"* %14, i64 2, i32 0
  store %"class.tensorflow::shape_inference::Shape"* %13, %"class.tensorflow::shape_inference::Shape"** %15, align 8, !noalias !8
  %16 = tail call %"class.tensorflow::shape_inference::Shape"* @_ZN10tensorflow15shape_inference16InferenceContext6VectorENS0_19DimensionOrConstantE(%"class.tensorflow::shape_inference::InferenceContext"* %1, %"class.tensorflow::shape_inference::Dimension"* null, i64 -1) #6, !noalias !8
  %17 = load %"class.tensorflow::shape_inference::ShapeHandle"*, %"class.tensorflow::shape_inference::ShapeHandle"** %7, align 8, !tbaa !2, !noalias !8
  %18 = getelementptr inbounds %"class.tensorflow::shape_inference::ShapeHandle", %"class.tensorflow::shape_inference::ShapeHandle"* %17, i64 3, i32 0
  store %"class.tensorflow::shape_inference::Shape"* %16, %"class.tensorflow::shape_inference::Shape"** %18, align 8, !noalias !8
  %19 = bitcast %"class.tensorflow::Status"* %0 to i64*
  store i64 0, i64* %19, align 8, !tbaa !11, !alias.scope !13
  ret void
}

declare %"class.tensorflow::shape_inference::Shape"* @_ZN10tensorflow15shape_inference16InferenceContext6MatrixENS0_19DimensionOrConstantES2_(%"class.tensorflow::shape_inference::InferenceContext"*, %"class.tensorflow::shape_inference::Dimension"*, i64, %"class.tensorflow::shape_inference::Dimension"*, i64) local_unnamed_addr #2
...
define internal void @_GLOBAL__sub_I_libsvm_ops.cc() #5 section "__TEXT,__StaticInit,regular,pure_instructions" {
  %1 = alloca %"class.tensorflow::register_op::OpDefBuilderWrapper", align 16
  %2 = tail call {}* @llvm.invariant.start.p0i8(i64 1, i8* getelementptr inbounds (%"class.Eigen::Symbolic::SymbolExpr", %"class.Eigen::Symbolic::SymbolExpr"* @_ZN5Eigen12placeholdersL4lastE, i64 0, i32 0)) #6
  %3 = tail call {}* @llvm.invariant.start.p0i8(i64 2, i8* getelementptr inbounds (%"class.Eigen::Symbolic::AddExpr", %"class.Eigen::Symbolic::AddExpr"* @_ZN5Eigen12placeholdersL3endE, i64 0, i32 0, i32 0)) #6
  %4 = tail call {}* @llvm.invariant.start.p0i8(i64 1, i8* getelementptr inbounds (%"struct.Eigen::internal::all_t", %"struct.Eigen::internal::all_t"* @_ZN5Eigen12placeholdersL3allE, i64 0, i32 0)) #6
  %5 = bitcast %"class.tensorflow::register_op::OpDefBuilderWrapper"* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 320, i8* nonnull %5) #6
  %6 = getelementptr inbounds %"class.tensorflow::register_op::OpDefBuilderWrapper", %"class.tensorflow::register_op::OpDefBuilderWrapper"* %1, i64 0, i32 0
  call void @_ZN10tensorflow12OpDefBuilderC1ENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i64 0, i64 0), i64 12) #6
  %7 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder5InputENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i64 0, i64 0), i64 13) #6
  %8 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder6OutputENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.6, i64 0, i64 0), i64 18) #6
  %9 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder6OutputENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i64 0, i64 0), i64 22) #6
  %10 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder6OutputENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.8, i64 0, i64 0), i64 21) #6
  %11 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder6OutputENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.9, i64 0, i64 0), i64 20) #6
  %12 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder4AttrENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.10, i64 0, i64 0), i64 47) #6
  %13 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder4AttrENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.11, i64 0, i64 0), i64 53) #6
  %14 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder4AttrENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.12, i64 0, i64 0), i64 22) #6
  %15 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder10SetShapeFnEPFNS_6StatusEPNS_15shape_inference16InferenceContextEE(%"class.tensorflow::OpDefBuilder"* nonnull %6, void (%"class.tensorflow::Status"*, %"class.tensorflow::shape_inference::InferenceContext"*)* nonnull @"_ZN10tensorflow3$_08__invokeEPNS_15shape_inference16InferenceContextE") #6
  %16 = call dereferenceable(320) %"class.tensorflow::OpDefBuilder"* @_ZN10tensorflow12OpDefBuilder3DocENS_11StringPieceE(%"class.tensorflow::OpDefBuilder"* nonnull %6, i8* getelementptr inbounds ([521 x i8], [521 x i8]* @.str.13, i64 0, i64 0), i64 520) #6
  ...
  call void @_ZN10tensorflow12OpDefBuilderD2Ev(%"class.tensorflow::OpDefBuilder"* nonnull %6) #6
  call void @llvm.lifetime.end.p0i8(i64 320, i8* nonnull %5) #6
  ret void
}
